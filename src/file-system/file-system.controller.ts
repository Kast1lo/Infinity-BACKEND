import { Controller, Post, Get, Param, Body, UseGuards, UseInterceptors, UploadedFile, Req, Delete } from '@nestjs/common';
...
export class FileSystemController {
  ...
  async deleteItem(
    ...
    return this.fileSystemService.deleteItem(req.user.userId, id, dto.type);
  }
}
