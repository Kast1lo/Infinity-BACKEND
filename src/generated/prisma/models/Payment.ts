...
export type PaymentWhereInput = {
  ...
  invId?: Prisma.IntFilter<"Payment"> | number
  ...
  isRecurringInit?: Prisma.BoolFilter<"Payment"> | boolean
...
export type PaymentOrderByWithRelationInput = {
  ...
  isRecurringInit?: Prisma.SortOrder
...
export type PaymentScalarWhereWithAggregatesInput = {
  ...
  invId?: Prisma.IntWithAggregatesFilter<"Payment"> | number
  ...
  isRecurringInit?: Prisma.BoolWithAggregatesFilter<"Payment"> | boolean
...
export type PaymentUpdateInput = {
  ...
  isRecurringInit?: Prisma.BoolFieldUpdateOperationsInput | boolean
...
export type PaymentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"invId" | "userId" | "planType" | "period" | "amount" | "status" | "isRecurringInit" | "description" | "createdAt" | "paidAt", ExtArgs["result"]["payment"]>
...
export interface PaymentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `invId`
   * const paymentWithInvIdOnly = await prisma.payment.findMany({ select: { invId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Payments and only return the `invId`
   * const paymentWithInvIdOnly = await prisma.payment.createManyAndReturn({
   *   select: { invId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Payments and only return the `invId`
   * const paymentWithInvIdOnly = await prisma.payment.updateManyAndReturn({
   *   select: { invId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PaymentFieldRefs {
  readonly invId: Prisma.FieldRef<"Payment", 'Int'>
  ...
  readonly isRecurringInit: Prisma.FieldRef<"Payment", 'Boolean'>
